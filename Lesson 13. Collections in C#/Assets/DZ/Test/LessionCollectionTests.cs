...
namespace Tests
{
    ...
    public sealed class LessonCollectionTests
    {
        ...
        {
            Assert.IsTrue(
                new HashSet<string> {"Кубок"}.SetEquals(
                    BagPacking(
            ...
            Assert.IsTrue(
                new HashSet<string> {"Кубок", "Тарелка", "Перстень"}.SetEquals(
                    BagPacking(
                        new Dictionary<string, (int weight, int price)>
                        {
                            {"Кольчуга", (80, 1000)},
            ...
            Assert.IsTrue(
                new HashSet<string> {"Перстень", "Кубок", "Тарелка"}.SetEquals(
                    BagPacking(
                        new Dictionary<string, (int weight, int price)>
                        {
                            {"Перстень", (10, 400)},
            ...
            Assert.IsTrue(
                new HashSet<string> {"Кубок", "Тарелка"}.SetEquals(
                    BagPacking(
                        new Dictionary<string, (int weight, int price)>
                        {
                            {"Кольчуга", (80, 1000)},
